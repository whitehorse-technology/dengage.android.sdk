...
public class Constants {
    ...
    public static final String TRANSACTIONAL_OPEN_API_ENDPOINT     = "https://pushdev.dengage.com/api/transactional/mobile/open";
    public static final String SUBSCRIPTION_API_ENDPOINT           = "https://pushdev.dengage.com/api/device/subscription";
    public static final String EVENT_API_ENDPOINT          = "https://eventdev.dengage.com/api/event";
