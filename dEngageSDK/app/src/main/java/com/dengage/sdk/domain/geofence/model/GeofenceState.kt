...
import com.dengage.sdk.util.ContextHolder
 ...
 object GeofenceState {
    ...
    private const val KEY_LAST_FAILED_STOPPED_LOCATION_TIME = "last_failed_stopped_location_time"
     ...
     var lastLocationProvider: String
     ...
     var lastMovedLocationLatitude: Float
     ...
     var lastMovedLocationLongitude: Float
     ...
     var lastMovedLocationAccuracy: Float
     ...
     var lastMovedLocationProvider: String
     ...
     var lastMovedLocationTime: Long
     ...
     var lastFailedStoppedLocationLatitude: Float
     ...
     var lastFailedStoppedLocationLongitude: Float
     ...
     var lastFailedStoppedLocationAccuracy: Float
     ...
     var lastFailedStoppedLocationProvider: String
     ...
     var lastFailedStoppedLocationTime: Long
