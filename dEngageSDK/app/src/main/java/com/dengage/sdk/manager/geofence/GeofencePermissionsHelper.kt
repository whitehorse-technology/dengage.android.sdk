...
object GeofencePermissionsHelper {
     ...
     fun fineLocationPermission(context: Context): Boolean {
     ...
     fun coarseLocationPermission(context: Context): Boolean {
        return ContextCompat.checkSelfPermission(
            context,
     ...
     fun getLocationPermissionStatus(context: Context): DengageLocationPermission {
