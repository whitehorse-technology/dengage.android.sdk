...
class CarouselDownloader {
    ...
    CarouselDownloader(Context context, CarouselItem[] carousalItems, @NonNull OnDownloadsCompletedListener onDownloadsCompletedListener) {
        ArrayList<CarouselItem> items = new ArrayList<>();
        if(carousalItems == null) return;
