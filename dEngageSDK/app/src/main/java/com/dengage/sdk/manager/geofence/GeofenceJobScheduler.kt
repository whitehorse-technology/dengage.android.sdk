...
class GeofenceJobScheduler : JobService() {
     ...
     companion object {
        ...
        private val counter = AtomicInteger()
         ...
         fun scheduleJob(context: Context, location: Location, source: GLC, geofenceRequestId: String?) {
    ...
    override fun onStartJob(params: JobParameters): Boolean {
        if (!DengageManager.getInstance(applicationContext).initalized) {
            DengageManager.getInstance(applicationContext).init()
        }
        ...
        DengageManager.getInstance(applicationContext).handleLocation(this.applicationContext, location, source, geofenceRequestId)
